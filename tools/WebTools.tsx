...
export const ColorConverter: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-lg mx-auto">
      <div 
        className="w-full h-32 rounded-xl shadow-inner border transition-colors" 
      ...
      <div className="grid gap-4">
         <div>
            ...
            <div className="flex gap-2">
               ...
               <input type="text" value={hex} onChange={(e) => setHex(e.target.value)} className="flex-1 p-2 border rounded uppercase" />
            </div>
         </div>
         <div>
            <label className="block text-sm font-bold mb-1">RGB Value</label>
            <div className="flex gap-2">
               <input type="text" readOnly value={`rgb(${rgb})`} className="flex-1 p-2 border rounded bg-gray-50" />
