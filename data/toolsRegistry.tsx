...
import { 
  ...
  Shuffle, IdCard, Briefcase, Truck, Database
} from 'lucide-react';
...
export const TOOLS: Tool[] = [
  ...
  { id: 'binary-trans', name: 'Binary Converter', description: 'Convert Text to Binary and vice-versa.', category: 'Text', path: '/tool/binary', icon: Binary, component: TextTools.BinaryConverter, isNew: true },
  { id: 'hex-trans', name: 'Hex Converter', description: 'Convert Text to Hex and vice-versa.', category: 'Text', path: '/tool/hex', icon: Hash, component: TextTools.HexConverter, isNew: true },
  { id: 'text-repeater', name: 'Text Repeater', description: 'Repeat text multiple times instantly.', category: 'Text', path: '/tool/repeater', icon: Repeat, component: TextTools.TextRepeater, isNew: true },
  { id: 'text-reverser', name: 'Text Reverser', description: 'Reverse text or flip words.', category: 'Text', path: '/tool/reverse', icon: ArrowRightLeft, component: TextTools.TextReverser, isNew: true },
  { id: 'morse-converter', name: 'Morse Code', description: 'Translate text to Morse Code.', category: 'Text', path: '/tool/morse', icon: Radio, component: TextTools.MorseConverter, isNew: true },
  ...
  { id: 'image-color', name: 'Color Picker', description: 'Pick colors from any image.', category: 'Image', path: '/tool/image-color', icon: Palette, component: ImageTools.ImageColorPicker, isNew: true },
  ...
  { id: 'pdf-split', name: 'Split PDF', description: 'Extract pages from PDF files.', category: 'PDF', path: '/tool/pdf-split', icon: Scissors, component: PdfTools.PdfSplit, isNew: true },
  ...
  // --- Web Tools ---
  { id: 'html-minifier', name: 'HTML Minifier', description: 'Minify HTML code.', category: 'CSS', path: '/tool/html-min', icon: Code, component: WebTools.HtmlMinifier, isNew: true },
  ...
  { id: 'robots-gen', name: 'Robots.txt Gen', description: 'Create robots.txt files.', category: 'SEO', path: '/tool/robots', icon: FileText, component: SeoTools.RobotsTxtGen, isNew: true },
  { id: 'keyword-density', name: 'Keyword Density', description: 'Check keyword frequency in text.', category: 'SEO', path: '/tool/keyword', icon: Search, component: SeoTools.KeywordDensity, isNew: true },

  // --- Placeholders ---
  { id: 'sitemap-gen', name: 'Sitemap Creator', description: 'Generate XML sitemaps.', category: 'SEO', path: '/tool/sitemap', icon: Globe, component: ComingSoon },
  { id: 'ascii-art', name: 'ASCII Art', description: 'Text to ASCII art.', category: 'Text', path: '/tool/ascii', icon: Type, component: ComingSoon },
  { id: 'slug-gen', name: 'Slug Generator', description: 'Make strings URL friendly.', category: 'SEO', path: '/tool/slug', icon: Globe, component: ComingSoon },
  { id: 'word-freq', name: 'Word Frequency', description: 'Analyze text repetition.', category: 'Text', path: '/tool/freq', icon: Type, component: ComingSoon },
  ...
  { id: 'ip-lookup', name: 'My IP Address', description: 'Show public IP info.', category: 'Developer', path: '/tool/ip', icon: Globe, component: ComingSoon },
  { id: 'gradient-gen', name: 'Gradient Gen', description: 'CSS Gradients creator.', category: 'CSS', path: '/tool/gradient', icon: Palette, component: ComingSoon },
];